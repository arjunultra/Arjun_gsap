...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (document.querySelector('.fireworks-contact')) {
      ...
      contactTL.from('.fireworks-contact-badge', {
          y: 20,
          opacity: 0,
          duration: 0.6
      })
      .from('.fireworks-contact-title', {
          y: 30,
          opacity: 0,
          duration: 0.7
      }, '-=0.4')
      .from('.fireworks-contact-subtitle', {
          y: 20,
          opacity: 0,
          duration: 0.6
      }, '-=0.3')
      .from('.fireworks-contact-subtitle::before, .fireworks-contact-subtitle::after', {
          scale: 0,
          opacity: 0,
          duration: 0.5
      }, '-=0.3');
      ...
      contactTL.from('.fireworks-contact-card', {
          y: 50,
          opacity: 0,
          duration: 0.8,
          stagger: 0.15,
      ...
      mapTL.from('.fireworks-contact-map-overlay', {
          y: -50,
          opacity: 0,
          duration: 0.7
      })
      .from('.fireworks-contact-map-embed', {
          opacity: 0,
          duration: 1,
          ease: 'power2.inOut'
      }, '-=0.3');
      ...
      document.querySelectorAll('.fireworks-contact-link-arrow').forEach(link => {
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (window.innerWidth > 767.98) {
    ...
    if (footer) {
      ...
      gsap.set(footer.querySelectorAll('.list-unstyled li'), { y: 20, opacity: 0 });
      ...
      .to(footer.querySelector('h3'), { y: 0, opacity: 1, duration: 0.6, ease: 'power2.out' })
      .to(footer.querySelectorAll('h5'), { 
        y: 0, 
        opacity: 1, 
        duration: 0.5, 
        stagger: 0.1,
      ...
      .to(footer.querySelectorAll('.list-unstyled li'), { 
        y: 0, 
        opacity: 1, 
        duration: 0.4, 
        stagger: 0.08,
      ...
      .to(footer.querySelectorAll('.footer-link'), { 
        x: 0, 
        opacity: 1, 
        duration: 0.3, 
        stagger: 0.05,
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  .from('.product-section .product-section-subtitle', {
    duration: 0.6,
    y: 20,
    opacity: 0,
    ease: 'power2.out'
  }, '-=0.4')
  .from('.product-section .product-section-divider', {
    duration: 0.8,
    scaleX: 0,
  ...
  const productButtons = document.querySelectorAll('.product-section .product-btn, .product-section .view-all-btn');
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (counterHeading && typeof SplitText !== 'undefined') {
    const splitHeading = new SplitText(counterHeading, { type: 'lines,words,chars' });
  ...
  // ===== ADDED PROPER MOTION PATH FLOATING EFFECTS =====
   ...
   if (typeof gsap !== 'undefined' && typeof MotionPathPlugin !== 'undefined') {
    const counterItems = document.querySelectorAll('.index-counter .counter-item');
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const ctaButtons = welcomeSection.querySelector('.welcome-section-cta-buttons');
  const heroImage = welcomeSection.querySelector('.welcome-section-main-image');
  const particles = welcomeSection.querySelectorAll('.welcome-section-particle');
  const scrollIndicator = welcomeSection.querySelector('.welcome-section-scroll-indicator');
  const heroImageContainer = welcomeSection.querySelector('.welcome-section-hero-image');
  
  // Infinite heartbeat animation for hero image
  ...
  // Split text animations triggered on scroll
  function setupScrollTriggeredTextAnimations() {
      // Split the main title
      ...
      // Hide all split elements initially
      ...
      // Animate subtitle characters on scroll
      ...
      // Animate description lines on scroll
  ...
  // Slide in animations for other elements triggered on scroll
  ...
  // Motion path for hero image
  function setupImageMotionPath() {
      // Define the motion path points
      const pathPoints = [
          {x: 0, y: -50},
          {x: 20, y: -30},
          {x: -10, y: 40},
  ...
  function initAnimations() {
      ...
      setupScrollTriggeredTextAnimations();
      setupScrollTriggeredElementAnimations();
      setupImageMotionPath();
  }
  
  // Check if elements exist before animating
  if (title && subtitle && description && heroImage) {
      initAnimations();
  }
  ...
  function handleResponsive() {
      ...
      if (isMobile) {
          // Revert split text on mobile if it causes layout issues
          // const splits = SplitText.getSplitText(title);
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  cards.forEach((card, i) => {
      ...
      // Motion path for floating effect
      tl.from(card, {
          y: 100,
          opacity: 0,
          duration: 0.8,
  ...
  ctaTl
      ...
      .from(cta.querySelector('h3'), {
          y: 20,
          opacity: 0,
          duration: 0.5
      }, "-=0.6")
      .from(cta.querySelector('p'), {
          y: 15,
          opacity: 0,
          duration: 0.4
      }, "-=0.4")
      .from(cta.querySelector('a'), {
          y: 10,
          opacity: 0,
          duration: 0.3
      }, "-=0.3");
  
  // Decoration animations (rotating elements)
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    gsap.fromTo('.pyro-heritage-badge', {
        scale: 0,
        rotation: -180,
        opacity: 0
    }, {
    ...
    gsap.fromTo('.pyro-timeline-line', {
        scaleY: 0,
        transformOrigin: 'top'
    }, {
        scaleY: 1,
    ...
    console.log('Pyro Masters About animations with GSAP SplitText initialized successfully!');
});
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Button animation
    const parallaxButton = document.querySelector('.about-parallax-button-wrapper');
    if (parallaxButton) {
...
// brands swiper
// Initialize Swiper
// Initialize Swiper with GSAP animations
document.addEventListener('DOMContentLoaded', function() {
  gsap.registerPlugin(ScrollTrigger);

  // Initialize Swiper
  const brandSwiper = new Swiper('.brands-section-swiper', {
      slidesPerView: 1,
      spaceBetween: 20,
      loop: true,
      autoplay: {
      ...
      on: {
          init: function() {
              animateVisibleSlides(this.slides);
          },
  ...
  // Function to animate visible slides
  function animateVisibleSlides(slides) {
      slides.forEach((slide, index) => {
          if (slide.classList.contains('swiper-slide-visible')) {
              ...
              const inner = slide.querySelector('.brands-section-slide-inner');
              const logo = slide.querySelector('.brands-section-logo img');
              const name = slide.querySelector('.brands-section-brand-name');
              const desc = slide.querySelector('.brands-section-brand-desc');
              ...
              // Add colorful spark effect
              if (!slide.classList.contains('has-sparks')) {
                  slide.classList.add('has-sparks');
                  addSparksToSlide(slide);
              }
          }
      });
  }

  // Function to add decorative sparks to slides
  function addSparksToSlide(slide) {
      const colors = ['#bf1719', '#f7ad45', '#732255'];
      
      // Create 3 sparks per slide
      for (let i = 0; i < 3; i++) {
          const spark = document.createElement('div');
          spark.className = 'brand-spark';
          spark.style.backgroundColor = colors[i];
  ...
  const brandTitle = document.querySelector('.brands-section-title');
  if (brandTitle) {
      const splitTitle = new SplitText(brandTitle, {
          type: "chars",
          charsClass: "char"
      });
  ...
  // Subtitle animation
  const brandSubtitle = document.querySelector('.brands-section-subtitle');
  if (brandSubtitle) {
      gsap.from(brandSubtitle, {
          y: 30,
          opacity: 0,
          duration: 0.8,
          ease: "power2.out",
  ...
  // Initial animation for visible slides on load
  animateVisibleSlides(document.querySelectorAll('.brands-section-slide'));
});
// navbar navigation active link check
 // JavaScript to handle active state based on current page
 document.addEventListener('DOMContentLoaded', function() {
